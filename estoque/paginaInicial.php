...
<body>
  ...
  <div class="p-1">
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-7">
          <h2 class="text-primary">Samsung s9
            <br>
          </h2>
        ...
        <div class="col-md-5 align-self-center">
          <img class="img-fluid d-block w-100 img-thumbnail" src="highlights_03_l.jpg"> </div>
      </div>
      <div class="row">
        <div class="col-md-5">
          <div class="embed-responsive embed-responsive-4by3">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/P_GG8KyXb-k" allowfullscreen=""> </iframe>
          </div>
          <div class="embed-responsive embed-responsive-4by3">
        ...
        <div class="col-md-7">
          <h2 class="text-primary pt-3">Novas Tecnologias
            <br>
          </h2>
          <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
            irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
