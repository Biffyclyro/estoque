        ...
        <div class="col-md-12">
          <form class="" method="post" action="controleEstoque.php">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Digite o nome do produto" value="<?php echo $descricao; ?>"> </div>
            <div class="form-group">
            ...
            <a class="btn btn-light" href="visualizarEstoque.php">Cancelar</a>
          </form>
        </div>
      </div>
    </div>
